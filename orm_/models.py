...
class Student(BaseModel):
    ...
    stu_class = models.ForeignKey(
        to="Classes",  on_delete=models.CASCADE, related_name="students", db_column='class_id',  null=True)

    courses = models.ManyToManyField(
        "Course", db_table="student_course", related_name="students", null=True)

    details = models.OneToOneField(
        "StudentDetail", on_delete=models.CASCADE, related_name="students")
